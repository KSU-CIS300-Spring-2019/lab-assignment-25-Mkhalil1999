...
namespace Ksu.Cis300.PriorityQueueLibrary
{
    public class MinPriorityQueue<TPriority, TValue> where TPriority : IComparable<TPriority>
    {
            ...
            LeftistTree<KeyValuePair<TPriority, TValue>> h2)
        {
            ...
            {
                int cmp = h1.Data.Key.CompareTo(h2.Data.Key);
                if(cmp < 0)
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> right = Merge(h1.RightChild, h2);
                    LeftistTree<KeyValuePair<TPriority, TValue>> p = new LeftistTree<KeyValuePair<TPriority, TValue>>(h1.Data, h1.LeftChild, right);
                    return p;
                }
                else
                {
                    LeftistTree<KeyValuePair<TPriority, TValue>> right = Merge(h2.RightChild, h1);
                    LeftistTree<KeyValuePair<TPriority, TValue>> s = new LeftistTree<KeyValuePair<TPriority, TValue>>(h2.Data, h2.LeftChild, right);
                    return s;
                }
            }
        }
        ...
        /// <summary>
        /// Gets Min Priority of Leftist Heap
        /// </summary>
        ...
        /// <summary>
        /// Removes min priority value as long as Heap is not null
